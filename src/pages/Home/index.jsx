        ...
        <div className="mb-6">
          <div className="flex flex-wrap items-center -mx-3 -mb-6">
            <div className="w-full sm:w-1/2 xl:w-1/4 px-3 mb-6">
              <div className="max-w-xs md:max-w-none mx-auto p-6 bg-brandBrown  rounded-xl">
                <div className="flex flex-wrap items-center -m-2">
                  ...
                  <div className="w-auto p-2">
                    <h5 className="text-xs text-gray-300 leading-5 font-semibold">Inventory</h5>
                    <div className="flex flex-wrap items-center -m-1">
                      <div className="w-auto p-1">
                        <span className="text-2xl leading-none text-gray-100 font-semibold">Value</span>
                      </div>
                      <div className="w-auto p-1">
                        <span className="bottom-0.5 inline-block py-1 px-2 text-xs text-green-500 font-medium bg-teal-900 rounded-full">100k</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="w-full sm:w-1/2 xl:w-1/4 px-3 mb-6">
              <div className="max-w-xs md:max-w-none mx-auto p-6 bg-brandBrown  rounded-xl">
                <div className="flex flex-wrap items-center -m-2">
                  ...
                  <div className="w-auto p-2">
                    <h5 className="text-xs text-gray-300 leading-5 font-semibold">Products</h5>
                    <div className="flex flex-wrap items-center -m-1">
                      <div className="w-auto p-1">
                        <span className="text-2xl leading-none text-gray-100 font-semibold">16</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="w-full sm:w-1/2 xl:w-1/4 px-3 mb-6">
              <div className="max-w-xs md:max-w-none mx-auto p-6 bg-brandBrown  rounded-xl">
                <div className="flex flex-wrap items-center -m-2">
                  ...
                  <div className="w-auto p-2">
                    <h5 className="text-xs text-gray-300 leading-5 font-semibold">System Users</h5>
                    <div className="flex flex-wrap items-center -m-1">
                      <div className="w-auto p-1">
                        <span className="text-2xl leading-none text-gray-100 font-semibold">4</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="mb-6">
          <div className="flex flex-wrap -mx-3 -mb-6">
            <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
              <div className="h-full max-w-sm mx-auto p-6 bg-brandBrown rounded-xl">
                ...
                <h5 className="text-lg text-gray-100 font-semibold mb-8">Sales</h5>
                <div className="flex mb-2 items-center justify-between">
                  <span className="text-xs text-blue-500 font-semibold">Jan</span>
                  <span className="text-xs text-gray-300 font-semibold">Dec</span>
                </div>
            ...
            <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
              <div className="relative h-full max-w-sm mx-auto p-6 bg-brandBrown rounded-xl">
                ...
                <h5 className="text-lg text-gray-100 font-semibold mb-12">Purchases</h5>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-300 font-semibold">Jan</span>
                  <span className="text-sm text-gray-300 font-semibold">Dec</span>
                </div>
              </div>
            </div>
            <div className="w-full lg:w-2/4 px-3 mb-6">
              <div className="relative h-full max-w-sm md:max-w-none mx-auto p-6 border bg-blue-300 text-gray-800 shadow-slate-100 rounded-xl">
                <div className="flex flex-wrap items-center justify-between -mx-2">
                  <div className="w-full md:w-1/2 px-2 mb-12 md:mb-0">
                    <div className="max-w-xxs pr-12">
                      <div className="flex flex-shrink-0 w-12 h-12 mb-9 items-center justify-center bg-blue-500 text-gray-900 bg-opacity-20 rounded-xl">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <h5 className="text-lg text-gray-800 font-semibold mb-1">Used percentage</h5>
                      <p className="text-sm text-gray-900font-semibold">Check your storage on your dashboard</p>
                    </div>
                  </div>
                  <div className="w-full md:w-1/2 px-2">
                    <div className="chart px-2" data-type="radial-bar-part" style={{ minHeight: '120px' }}></div>
                    <div className="flex items-end justify-center -mt-12">
                      <span className="text-3xl leading-none text-gray-800 font-semibold">64</span>
                      <span className="text-2xl leading-none text-gray-600 font-semibold">%</span>
                    </div>
                  </div>
                </div>
              </div>
