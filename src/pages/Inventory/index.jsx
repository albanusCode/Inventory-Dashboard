...
const index = () => {
  ...
  return (
    <div className="h-full overflow-x-hidden mr-4 mt-1">
      <h4 className="text-xl lg:text-3xl text-gray-600 font-bold mb-4 shadow-xl w-full p-2 rounded-lg">Inventory Management</h4>
      ...
      <div className="lg:flex lg:space-x-auto my-7">
        <div className="flex flex-col space-y-7 lg:w-4/12 w-full">
          ...
          <Card className="p-2 py-4 shadow-xl z-[-10]">
        ...
        <Container className="lg:w-8/12 rounded-lg mx-auto py-3">
          ...
          <div className="h-96 shadow-xl custom-scrollbar md:w-[655px]">
            <DataGrid
